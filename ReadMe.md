...
2. How would you explain form validation to someone who has never programmed before?
    ...
    Form validation is used to ensure that the user inputs the correct data in the field and that it meets any specific requirements. To make the validation easier, we use the library Yup to handle the validation. Yup has built in methods to deal with email addresses, passwords, strings, numbers, and more. 

3. In 1-2 sentences, define end to end testing. 

    End to End testing is testing that evaluates the entire user experience. Focuses on UI and simulating events as if a user was using your website... basically an imaginary friend testing out the app.
